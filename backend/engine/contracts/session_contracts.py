"""
Generic session lifecycle message types.

These are domain-agnostic — any teaching domain (Eurydice, Logos, etc.)
uses the same wire format for session control, text/audio streaming,
tool calls, and error reporting.
"""
